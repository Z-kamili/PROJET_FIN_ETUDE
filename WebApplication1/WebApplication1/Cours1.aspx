<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cours1.aspx.cs" Inherits="WebApplication1.Cours1" %>
	...
	<div class="wrapper">
		<div class="nav">
			...
			<div class="menu"> 
                ...
                <%-- Resulta Final --%>
                <div class="DivLandingPage DIVpos" runat="server" id="Afficher_Resultats">
                    <asp:Button CssClass="BTNValider" ID="prd" runat="server"  Text="Telecharger" OnClick="Unnamed1_Click"  />
                    <div class="inner">
                        <asp:Panel ID="pnl1" runat="server">
                            <p class="PQuastions" id="success">Developpement avec c# le  Cour complets</p><br/>
