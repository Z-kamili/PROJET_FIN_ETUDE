<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cours3.aspx.cs" Inherits="WebApplication1.Cours3" %>
	...
	<div class="wrapper">
		<div class="nav">
			...
			<div class="menu"> 
                ...
                <%-- Resulta Final --%>
                <div class="DivLandingPage DIVpos" runat="server" id="Afficher_Resultats2">
                    <asp:Button CssClass="BTNValider" runat="server" ID="prd2"  Text="Telecharger" OnClick="Unnamed1_Click"  />
                    <div class="inner">
                        <asp:Panel ID="pnl1" runat="server">
                            <p class="PQuastions" id="success">Developpement Web le Cour complets</p><br/>
